export default {
  ...
  ,mjchat:{
    ...
    ,yourHead:'你的头像'
    ,your2Head:'明星图'
    ,tipInfo:'说明：<li>1 图片都必须包含脸，否则出不来图</li> <li>2 “明星图”可以先用mj绘画制作出来</li> <li>3 “明星图”其实动漫图也行</li> <li>4 “你的头像”建议用一寸个人照</li><li style="color:#f2c97d">5. 请不要使用政治相关、色情、血腥、暴恐等图片 一经发现将积分清零</li>'
    ,placeInput: '请填写提示词！'
    ,more5sb: '最多上传5张图片'
    ...
    ,imgCYes:'含有垫图'
    ,imgCUpload:'自传垫图'
    ,imgCInfo:'垫图说明：<br/> 1.垫图可使用自己的图片作为基础，让MJ来绘图<br/> 2.可以使用多张垫图 最多5张， 单张图片不超过1M<br/><div style="color:#f2c97d">3. 请不要使用政治相关、色情、血腥、暴恐等图片 一经发现将积分清零</div>'
    ,imgCadd:'+添加'
    ,del:'删除'
    ,img2text:'图生文'
    ...
    ,tStyles:'艺术程度'
    ,tVersion:'模型版本'
    ,dalleInfo:' 说明：   <li>1 dall-e 是openAi提供的画图模型</li>  <li>2 openAi的图片有时效性，请做好备份</li>   <li>3 注意：1790px的图片价格是双倍</li><li style="color:#f2c97d">4 请不要使用政治相关、色情、血腥、暴恐等图片 一经发现将积分清零</li> '
    ,version:'版本'
    ,size:'尺寸'
    ,blendInfo:'说明： <li>1 合成至少2张图片</li> <li>2 最多可传6张图</li><li style="color:#f2c97d">3 请不要使用政治相关、色情、血腥、暴恐等图片 一经发现将积分清零</li> '
    ,blendStart:'开始合成'
    ,no2add:'请勿重复添加图片'
    ,add2more:'请添加两张以上图片'
    ,no1m:'图片大小不能超过1M'
